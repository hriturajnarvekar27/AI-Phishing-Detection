...
|---------------------|---------------|------------------|-------------|
| ![Dashboard](AI_Phishing_Detector/Photos/dashboard-overview.png) | ![URL](AI%Phishing%Detector/Photos/url-detection.png) | ![Email](AI%Phishing%Detector/Photos/email-detection.png) | ![History](AI%Phishing%Detector/Photos/scan-history.png) |
